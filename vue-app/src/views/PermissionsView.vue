<template>
    <el-card class="box-card">
      <template #header>
        <div class="card-header">
          <span>权限管理</span>
          <el-button type="primary" icon="CirclePlus" round @click="handleDialog(null)">添加权限</el-button>
        </div>
      </template>
  ...
  import AddUsers from '@/components/AddPermissions.vue';
  ...
  //获取分类的信息
  const getList=()=>{
  return axios.get('/Permissions').then((res)=>{
